...
<head>
    ...
    <title>SELL | <?php echo $user['name']; ?> </title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="page-wrapper elevation-3 col-lg-3" style="border-radius:25px;">
                                <div class=" col-lg-10 ">
                                    <br>
                                    <h4 class="ml-4 text-dark"> กรุณากรอกข้อมูลรายการขาย </h4>
                                    <p class="ml-4 text-dark"> ( Sell Details ) </p>
                    ...
                    <div class="row">
                        <div class="col-lg-10  mb-4 mb-lg-0">
                            <div class="card" style="border-radius:50px;">
                                <div class="card-body text  bg-light elevation-4" style="border-radius:50px;">
                                    <br>
