...
class Google_Service_Vision_GoogleCloudVisionV1p4beta1journalSearchResultsGroupedResult extends Google_Collection
{
  protected $collection_key = 'results';
  protected $boundingPolyType = 'Google_Service_Vision_GoogleCloudVisionV1p4beta1BoundingPoly';
  protected $boundingPolyDataType = '';
  protected $objectAnnotationsType = 'Google_Service_Vision_GoogleCloudVisionV1p4beta1journalSearchResultsObjectAnnotation';
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1p4beta1journalSearchResultsObjectAnnotation
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1p4beta1journalSearchResultsObjectAnnotation
   */
