...
class Google_Service_Vision_GoogleCloudVisionV1p5beta1journalSearchResults extends Google_Collection
{
  protected $collection_key = 'results';
  public $indexTime;
  protected $journalGroupedResultsType = 'Google_Service_Vision_GoogleCloudVisionV1p5beta1journalSearchResultsGroupedResult';
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1p5beta1journalSearchResultsGroupedResult
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1p5beta1journalSearchResultsGroupedResult
   */
