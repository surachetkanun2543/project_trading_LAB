...
if (!empty($_POST['q_name'])) {
    $sql_search = " where Assettype_name like '%" . $_POST['q_name'] . "%' "; // like '%keyword%'
} else {
    $sql_search = '';
}
...
<table class="table table-striped shadow  mb-3 ">
    ...
    ?>
            <tr>
                ...
                <td> <a href="#" onclick="javascript:del('<?php echo $row['Assettype_id']; ?>');" class='btn btn-outline-danger btn-lg shadow p-1' style="width: 50px;height: 38px;"><i class="fa fa-bitbucket"></i> </a></td>
            </tr>
