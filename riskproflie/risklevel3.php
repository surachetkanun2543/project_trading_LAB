...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card ml-5 elevation-3 " style="width: 79rem; ">
                <div class="card-header  elevation-2 text-center bg-warning"><br>
                    <h3>
                        Investment Portfolio Assessment</h3>
                </div>

                <img style="padding: 10px; width: 1200px; height: 700px;" class="responsive " src="../assets/img/save3.png" alt="risklevel1" />
                <div class="card-body">
                    <hr>
                    <h4 class="card-title font-weight-bold">เคล็ด (ไม่ลับ)</h4>
                    <p class="card-text"> -------------- ‘การจัดพอร์ตลงทุน’ ก็แสนง่าย นั่นคือ ต้องรู้และเข้าใจสินทรัพย์ที่จะลงทุน, ลงทุนในจำนวนที่พอดี ที่เราสามารถดูแลได้ไหว และติดตามข้อมูลข่าวสาร ปรับพอร์ตให้เข้ากับสถานการณ์ ที่สำคัญการจัดพอร์ตกองทุนรวมในปัจจุบันไม่ได้ใช้เงินลงทุนมากอย่างที่คิด สามารถเลือกลงทุนด้วยตัวเองได้ง่าย ๆ หรือ ใครที่จัดพอร์ตไม่เป็น ในปัจจุบันก็มีหลายแห่งที่ให้บริการจัดพอร์ตลงทุนแบบอัตโนมัติผ่าน ‘Robo Advisor’ ซึ่งไม่ได้เสียค่าธรรมเนียมเพิ่มด้วย ซึ่งนักลงทุนที่สนใจสามารถติดตามแนวคิดในเรื่องการจัดพอร์ตลงทุนและข้อมูลที่เกี่ยวกับการลงทุนเพิ่มเติมได้จากเว็บไซต์</p>
